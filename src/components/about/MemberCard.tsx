    ...
    <div className="bg-white shadow-md rounded-lg p-6 text-center transition-transform transform hover:scale-105 max-w-md mx-auto">
      ...
      <div className="relative w-[300px] aspect-[9/16] group transform-style-preserve-3d transition-transform duration-[400ms] mb-4 mx-auto">
        ...
        <img
          ...
          className="rounded-lg absolute inset-0 w-full h-full object-cover z-10 transform transition-transform duration-[400ms] group-hover:rotate-x-[25deg] group-hover:translate-z-[-35px]"
        />

        {/* Logo (or name if logo is not available) */}
        <div className="absolute top-auto shadow-2xs border-red-500 left-0 right-0 bottom-8 mx-auto w-[65%] text-white font-bold text-2xl filter-invert transform translate-z-[20px] transition-transform duration-[400ms] group-hover:translate-y-[-2rem] group-hover:rotate-x-[-20deg] z-[1000]">
          {logoImage ? (

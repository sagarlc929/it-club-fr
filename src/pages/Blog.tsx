...
const blogs = [
  ...
  },
  {
    ...
    content:
      "In this tutorial, we’ll walk through the steps of building a simple web application using modern frameworks like React and Express. You’ll learn about setting up a project, integrating frontend and backend technologies, and managing user authentication. Whether you're new to web development or looking to expand your skills, this guide will help you get started with building full-stack web apps.",
